  ...
  return (
    <main className="content page about">
      ...
      <ol>
        ...
        <li><b>The bill keyword search looks at the <i>bill's title only</i>.</b> It does <i>not</i> search the bill's text. If you are expecting to find bills for a keyword and aren't, do a search on leginfo {MDASH} which will search the bill text {MDASH} then use the titles or bill numbers you find there. For example "tobacco", will not return any bills on the tool, but "smoking" will, since the bills only have "smoking" in their titles. </li>
      ...
      <p>Such small-seeming misunderstandings about how the search works can be the difference between finding crucial information or not. I will continue to work on improving both the interface and the search logic as best as I can, but in the meantime, hopefully these help.</p>
